...
var _vetShelterJs = require("./vetShelter.js");
...
async function loadBreeds() {
    ...
    try {
        const breeds = await (0, _petAPIJs.getBreeds)();
        loader.textContent = "";
        for(const breed in breeds)if (breeds[breed].length) breeds[breed].forEach((sub)=>{
...
async function showDog() {
    ...
    name.textContent = "";
    try {
        const dogUrl = await (0, _petAPIJs.getRandomDogByBreed)(breed);
        img.src = dogUrl;
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    loadBreeds();
    (0, _galleryJs.setupGallery)(document.getElementById('gallery'), document.getElementById('loader'), 15);
    select.addEventListener("change", showDog);
    (0, _calendarJs.setupCalendar)();
    (0, _vetShelterJs.setupVetShelter)();
    AOS.init();
});

},{"./modal.js":"jJ31c","./petAPI.js":"ejojj","./statistic.js":"fjW78","./gallery.js":"cOqsp","./calendar.js":"5Lz3E","./vetShelter.js":"hBkbR"}],"jJ31c":[function(require,module,exports,__globalThis) {
...
function setupAdoptModal() {
    ...
    // 🟣 Modals
    const [adoptModal, volunteerModal, donateModal] = document.querySelectorAll(".form-container, .volunteer-form, .donate-form");
...
},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
},{"./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cOqsp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
var _petAPIJs = require("./petAPI.js");
async function setupGallery(galleryContainer, loaderElement, limit = 15) {
    ...
    try {
        ...
        for (const breed of breedNames)try {
            const dogUrl = await (0, _petAPIJs.getRandomDogByBreed)(breed);
...
/* 🐕 Create gallery card element */ function createGalleryItem(breed, imageUrl) {
...
},{"./petAPI.js":"ejojj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5Lz3E":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@fullcalendar/core":"9u9jF","@fullcalendar/daygrid":"jiZAV","@fullcalendar/timegrid":"l0uCF","@fullcalendar/list":"l9dNA"}],"9u9jF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function expandRanges(daysOfWeek, startTime, eventDateEnv, calendarDateEnv, framingRange) {
    ...
    if (startTime) {
        if (startTime.milliseconds < 0) // possible for next-day to have negative business hours that go into current day
        endMarker = (0, _internalCommonJs.t)(endMarker, 1);
        else if (startTime.milliseconds >= 86400000) // possible for prev-day to have >24hr business hours that go into current day
...
class NowTimer extends (0, _preact.Component) {
    ...
    computeTiming() {
        ...
        if (nowIndicatorSnap === 'auto') nowIndicatorSnap = // large unit?
...
},{"@fullcalendar/core/internal.js":"4CP9d","@fullcalendar/core/preact.js":"lbU3B","@fullcalendar/daygrid/internal.js":"4zgAk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"l9dNA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>index);
var _indexJs = require("@fullcalendar/core/index.js");
...
},{"@fullcalendar/core/internal.js":"4CP9d","@fullcalendar/core/preact.js":"lbU3B","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hBkbR":[function(require,module,exports,__globalThis) {
// vetShelter.js
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setupVetShelter", ()=>setupVetShelter);
function setupVetShelter() {
    setTimeout(()=>{
        ...
        // });
        // ✅ Initialize map
        const map = L.map("vet-map").setView([
            10.3157,
            123.8854
        ], 12); // Cebu City default
        ...
        \u{1F4CD} ${place.address}<br>
        \u{1FA7A} ${place.type}<br><br>
        <a href="https://www.google.com/maps/dir/?api=1&destination=${place.coords[0]},${place.coords[1]}"
           target="_blank"
           style="color:#0078d7;">\u{27A1}\u{FE0F} Get Directions</a>
      `);
            return marker;
        });
        // ✅ Render list items
      ...
      `).join("");
        ...
        listContainer.addEventListener("click", (e)=>{
            ...
            map.setView(places[index].coords, 15, {
                animate: true
            });
            marker.openPopup();
...
//# sourceMappingURL=petph.me.57da488a.js.map
